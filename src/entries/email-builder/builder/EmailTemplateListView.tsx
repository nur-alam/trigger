...
const EmailTemplateListView = ({ template, isSelected, onSelect, onEdit, onPreview, onDuplicate }: EmailTemplateListViewProps) => {
	...
	return (
		<div className={`flex items-center p-4 bg-white border rounded-lg hover:bg-gray-50 ${isSelected ? 'ring-2 ring-blue-500 border-blue-500' : 'border-gray-200'
			...
			{/* Selection Checkbox */}
			<div className="flex gap-2 mr-2 max-w-[500px]">
				<input
					type="checkbox"
					checked={isSelected}
					onChange={onSelect}
					className="rounded border-gray-300 text-blue-600 focus:ring-blue-500 mr-4 !mt-[3px]"
				/>
				<div className="">
			...
			<div className="flex-1 min-w-0">
				<div className="flex gap-2 items-center justify-end align-content-end">
