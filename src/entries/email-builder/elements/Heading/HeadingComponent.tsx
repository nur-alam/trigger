...
const HeadingComponent = (props: { label: string; content: string; position: string; size: string; style: any }) => {
	...
	return <div style={elementStyle}>{content || 'Heading element'}</div>;
};
